...
import 'pdf/AddingDealerPrice.dart';

class qrScannerik extends StatefulWidget {
  const qrScannerik({Key? key}) : super(key: key);

  @override
  State<qrScannerik> createState() => _qrScannerikState();
}

class _qrScannerikState extends State<qrScannerik> {
  @override
  void initState() {
    super.initState();
        ...
        Stack(
          ...
          children: [
            Padding(
              ...
              child: Lottie.asset(
                'assets/123752-start-up-meeting.json',
              ),
            ),
            Positioned(
              top: 0,
...
//
// class FutureBuilderScannedItem extends StatelessWidget {
//   const FutureBuilderScannedItem({
//     Key? key,
...
//             if (snap.hasData) {
//               Map? datal = snap.data!.data();
//               return Text(
//                 datal!['model'].toString().toUpperCase(),
